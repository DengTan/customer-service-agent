...
async function main() {
  // Supabase 连接配置 - 使用 Connection Pooler
  // Connection Pooler 端口: 6543
  const connectionString = process.env.DATABASE_URL || 
    'postgresql://postgres:@aws-0-eu-central-1-0.pooler.supabase.com:6543/postgres';
